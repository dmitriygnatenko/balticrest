...
/* WEBPACK VAR INJECTION */(function($) {var initializeMap = function initializeMap() {
  ...
  function getBalloonContent(item) {
    if (item.link !== '') {
      ...
      return ymaps.templateLayoutFactory.createClass('<img src="' + item.image + '" class="logotype">' + '<h3>' + item.title + '</h3>' + '<span>' + item.description + '</span>');
    }
  }
