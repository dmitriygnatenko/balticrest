...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/balticrest/balticrest-map.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./assets/balticrest/balticrest-map.js":
/*!*********************************************!*\
  !*** ./assets/balticrest/balticrest-map.js ***!
  \*********************************************/
/*! no exports provided */
...
/* harmony import */ var _balticrest_js_map_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./balticrest/js/map_index.js */ "./assets/balticrest/balticrest/js/map_index.js");

window.initializeMap = _balticrest_js_map_index_js__WEBPACK_IMPORTED_MODULE_0__["default"];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {var initializeMap = function initializeMap() {
  var activePoint;
  ymaps.ready(init);
  ...
  function init() {
    ...
    map_data.points.forEach(function (item) {
      ...
      map.geoObjects.add(point); // Image preload
  ...
  function getBalloonLayout() {
    return ymaps.templateLayoutFactory.createClass('<div class="marker_info">' + '<div class="info">' + '<button type="button" class="close"><span>&times;</span></button>' + '$[[options.contentLayout]]' + '<span class="arrow"></span>' + '</div>' + '</div>', {
      ...
      getShape: function getShape() {
        ...
        return new ymaps.shape.Rectangle(new ymaps.geometry.pixel.Rectangle([[position.left, position.top - 30], [position.left + this._$element[0].offsetWidth, position.top + this._$element[0].offsetHeight]]));
      }
    });
  }
...
/* harmony default export */ __webpack_exports__["default"] = (initializeMap);
