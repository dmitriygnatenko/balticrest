...
class CacheManager implements CacheManagerInterface, CacheTagInterface, CacheKeyInterface
{
     ...
     * @return string
     */
    public function getListPointsCacheKey(string $city, string $category, string $locale): string
    {
        return self::KEY_LIST_POINTS . $city . $category . $locale;
    }
     ...
     * @return string
     */
    public function getPointCacheKey(string $url, string $locale): string
    {
        return self::KEY_POINTS . $url . $locale;
    }
     ...
     * @return string
     */
    public function getNewsCacheKey(int $page, string $tag, string $locale): string
    {
